...
class SettingsPageV3 extends StatelessWidget {
  const SettingsPageV3({super.key, required this.store});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'O texto fica assim.',
                  style: TextStyle(fontSize: value, height: 1.35),
                ),
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
        animation: store,
        builder: (_, __) {
          final archived = store.notes.where((n) => n.archived && n.deletedAt == null).length;
          final trash = store.notes.where((n) => n.deletedAt != null).length;
              ...
              children: [
                ...
                NotoTile(
                  ...
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => legacy.ArchivePage(store: store)),
                  ),
                ),
                NotoTile(
                  ...
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => legacy.TrashPage(store: store)),
                  ),
                ),
                const SizedBox(height: 28),
